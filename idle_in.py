...
idle_count = 'scripts/idle_in_transaction_count.sql'
...
locks_error = 'No one hightweght lock'
...
def output():
    ...
    _result6, error = get_data(_srv,_login,_pwd,_dbname,idle_count)
    first_tuple_elements = [a_tuple[0] for a_tuple in _result5]
    first_tuple_elements_idle = [a_tuple[0] for a_tuple in _result6]
    ...
    if error_fatal:
        ...
        if first_tuple_elements[0] >= 1:
            return render_template('output_hightweight.html', tt1=t1, tt2=t2, data1=_result, data2=_result1, data3=_result2, data4=_result3, data5=_result4)
        elif first_tuple_elements_idle[0] >= 1:
            return render_template('output_idle.html', tt1=t1, tt2=t2, data1=_result, data2=_result1, data3=_result2, data4=_result3, data5=_result4)
        else:
            return render_template('output.html', tt1=t1, tt2=t2, data1=_result, data2=_result1, data5=_result4)
