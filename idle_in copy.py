...
def output():
    ...
    _result1, error1 = get_data(_srv,_login,_pwd,_dbname,idle)
    _result2, error2 = get_data(_srv,_login,_pwd,_dbname,locks)
    _result3, error3 = get_data(_srv,_login,_pwd,_dbname,locks_kill)
    _result4, error4 = get_data(_srv,_login,_pwd,_dbname,list_connections)
    ...
    if error_fatal:
        ...
        return render_template('output_error.html', data_error=_result)
    elif error1:
        return render_template('output_error.html', data_error=_result1)
    elif error2:
        return render_template('output_error.html', data_error=_result2)
    elif error3:
        return render_template('output_error.html', data_error=_result3)
    else:
    ...
    # else:
    #     if list(map(int, _result3)) != 0:
    #         return render_template('output.html', tt1=t1, tt2=t2, data1=_result, data2=_result1, data3=_result2)
    #     else:
    #         return render_template('output_locks_error.html', tt1=t1, tt2=t2, data1=_result, data2=_result1, data_error_locks=not_locks)
